...
export const QUESTIONS_LISTENING: Question[] = [
  ...
  },
  {
    "id": "p3-mi-002",
    "part": "Part 3",
    "question": "When is the meeting with the client now scheduled to take place?",
    "choices": {
      "A": "On Tuesday",
      "B": "On Wednesday",
      "C": "On Thursday",
    ...
    "answer": "C",
    "explanation_zh": "細節題：女生說 'I need to push our meeting with the client to Thursday'，會議改到星期四。(A) Tuesday 是臨時有急事的日子，(B) Wednesday 是議程準備好的期限，都是干擾混淆點。",
  ...
  },
  {
    ...
    "choices": {
      "A": "Her order number",
      "B": "Her new address",
      "C": "Her payment method",
      "D": "Her telephone number"
    },
    "answer": "B",
    "explanation_zh": "細節題：男生說 'May I have the new address, please?'，他要的是新地址。(A) 訂單編號是女生主動提供的，不是男生問的——這是典型「資訊出現過但對應錯誤」的干擾選項。",
    "skill_tag": "listening_detail",
    "difficulty": "B1",
    "vocabulary": [
      "order number",
  ...
  },
  {
    "id": "p3-rs-003",
    "part": "Part 3",
    "question": "When will the address change take effect?",
    "choices": {
    ...
    "answer": "A",
    "explanation_zh": "細節題：男生最後說 'The change will be applied within the next hour'。注意聽結尾的時間資訊，P3 最後一題常考對話收尾的承諾或時程。",
    "skill_tag": "listening_detail",
    "difficulty": "B1",
    "vocabulary": [
      "applied",
  ...
  },
  {
    "id": "p4-mi-002",
    "part": "Part 4",
    "question": "Why should listeners contact extension 4500?",
    "choices": {
      "A": "To report urgent issues",
      "B": "To schedule system maintenance",
      "C": "To request time off",
      "D": "To register for a training session"
    },
    "answer": "A",
    "explanation_zh": "細節題：結尾說 'If you have urgent issues, contact the IT helpdesk at extension 4500'。分機號碼幾乎一定會出題，聽到數字要立刻連結它的用途。",
    "skill_tag": "listening_detail",
    "difficulty": "B1",
    "vocabulary": [
      "urgent issues",
  ...
  },
  {
    "id": "p4-lc-002",
    "part": "Part 4",
    "question": "What are listeners reminded to do before exiting?",
    "choices": {
      "A": "Show their tickets to the staff",
      "B": "Make sure they have all their luggage",
      "C": "Move to the front carriage",
      "D": "Fill out a travel survey"
    },
    "answer": "B",
    "explanation_zh": "細節題：廣播說 'Before exiting, please make sure you have all your luggage with you'。reminded to do 題型直接對應廣播中的 please + 動詞指令句。",
    "skill_tag": "listening_detail",
    "difficulty": "A2",
    "vocabulary": [
      "exiting",
  ...
  },
  {
    "id": "p4-lc-003",
    "part": "Part 4",
    "question": "According to the speaker, where will the doors open?",
    "choices": {
      "A": "On the left-hand side",
      "B": "On the right-hand side",
      "C": "On both sides",
      "D": "At the rear of the train"
    },
    "answer": "B",
    "explanation_zh": "細節題：'The doors on the right-hand side will open at the platform'。方位詞（left/right/front/rear）是 P4 交通廣播的高頻考點，聽到要立刻筆記。",
    "skill_tag": "listening_detail",
    "difficulty": "A2",
    "vocabulary": [
      "right-hand side",
  ...
  },
  {
    ...
    "answer": "D",
    "explanation_zh": "照片中聽眾坐在會議廳內聆聽講臺上的演講者，因此 (D) 正確。(A) 的動作錯誤，聽眾坐著而非站著鼓掌。(B) 的照片中不存在的物件錯誤，畫面中沒有分發資料的場景。(C) 的時態錯誤，使用過去式 'yesterday'。",
    "skill_tag": "listening_photo",
    "difficulty": "B2",
    "vocabulary": [
      "audience",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation_zh": "照片中工人正從貨車上卸下箱子到卸貨平臺，因此 (C) 正確。(A) 的動作方向錯誤，是卸貨而非裝貨。(B) 的地點錯誤，貨車在卸貨區而非停車場。(D) 的時態錯誤，使用過去式 'unloaded'。",
    "skill_tag": "listening_photo",
    "difficulty": "B1",
    "vocabulary": [
      "unloading",
